...
export default function ProgressPage() {
  ...
  const logWeight = () => {
    if (!wWeight) return
    const e = { date: wDate, weight: wWeight, bf: wBf, notes: wNotes }
    saveWeightLog([...weightLog, e])
  ...
  return (
    <div className="hub-page">
      <div className="page-header">
        <div>
          <h2>Progress</h2>
          <div className="sub">Weight · swim · bike · run · brick sessions</div>
        </div>
        <div className="page-header-right">
          Starting: ~205 lbs<br />
          Goal: ~0.9 lbs/wk deficit
        </div>
      </div>
      ...
      <div className="tracker-card">
        ...
        <div className="tracker-stats">
          <div className="tracker-stat">
            <div className="tracker-stat-val">{weights.length > 0 ? `${weights[weights.length - 1]} lbs` : '—'}</div>
            <div className="tracker-stat-lbl">Current</div>
          </div>
          <div className="tracker-stat">
            <div className="tracker-stat-val">{weights.length > 0 ? `${weights[0]} lbs` : '—'}</div>
            <div className="tracker-stat-lbl">Starting</div>
          </div>
          <div className="tracker-stat">
            <div className="tracker-stat-val">
      ...
      <div className="tracker-card">
        ...
        <div className="tracker-stats">
          ...
          <div className="tracker-stat">
            <div className="tracker-stat-val">{allBricks.slice(-1)[0]?.date || '—'}</div>
            <div className="tracker-stat-lbl">Last brick</div>
          </div>
        </div>
